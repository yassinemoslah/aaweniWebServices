...
$return_arr = array();
$id = $_GET['id'];
$sql = "SELECT D.*, A.*, C.* FROM Demande D JOIN Adresse A on D.Demande_ID=A.idDemande JOIN CordgeoDemande C on C.Cord_ID=D.Cordgeo_ID WHERE D.urgente=1 and D.clientD_User_ID=".$id." order by D.Demande_ID desc";
